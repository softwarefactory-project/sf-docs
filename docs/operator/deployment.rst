...
All the services could run together with 4CPU, 8GB of memory and 20GB of disk,
...
recommended to run all the services inside a single network.
For examples, internal network usually need:
...
service credencials, in the sfconfig.yaml file

...
<<<<<<< HEAD
  Software Factory, you will found useful this :ref:`migration documentation <migration>`
...
||||||| parent of c4019cf... Add zuulV3 deployment documentation
...
=======
  Software Factory, you will found useful this `migration documentation <migration>`_
  to easily migrate your workflow to a Software Factory instance.
* The `access control documentation <access_control>`_ explains how to configure the
>>>>>>> c4019cf... Add zuulV3 deployment documentation

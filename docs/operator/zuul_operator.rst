...
Make sure the zuul service logging is configured to use level: DEBUG in the /etc/zuul/*-logging.yaml file. This can be enabled globally by setting this variable:

...
.. note::
  ...
  below, is then no longer mandatory, see the `Zuul tenants from resources <zuul-resources-integration>`
  for more details. Also note that Zuul's tenants definition file, like below,

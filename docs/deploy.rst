...
.. code-block:: bash
  ...
  $ wget http://46.231.132.68:8080/v1/AUTH_b50e80d3969f441a8b7b1fe831003e0a/sf-images/softwarefactory-C7.0-2.6.0.img.qcow2
...
Then, create the Heat stack, either by passing parameters in-line:
...
.. code-block:: bash
  ...
  parameters:
    key_name: keypair
    image_id: uuuu-iiii-dddd-0000
    external_network: uuuu-iiii-dddd-0000
    domain: softwarefactory.domain.tld
    flavor: m1.large
  EOF
  $ openstack stack create sf_stack --template softwarefactory-C7.0-2.6.0-allinone.hot --parameter-file parameters.yml
...
When Heat is not available, Software Factory can also be deployed manually
using the Nova CLI, or using the web UI of your cloud provider.

...
Though it is make this service optional in the futur:

* Access control are going to be based on the config resources directly.
* Deployment script may support external git server to store the config repository.

Note that it is possible to use Software Factory as a third party CI for
external Gerrit or GitHub organization. In this case, the gerrit server
is only used to host the config repository, and operator can avoid using it
entirely by pushing config repository change with "git push" instead of
"git review".
...
How can I change my deployment hostname?
........................................
